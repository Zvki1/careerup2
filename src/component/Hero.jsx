...
const Hero = () => {
  return (
    <div className=" pt-24 bg-[#0A090F] text-white relative pb-24">
      {/* h1 and cta div */}
      ...
      {/* image */}
      <img width={90} src={Motif} alt=""  className="absolute z-0 top-8 right-0"/>
      {/* the two cards */}
      <div className=" pt-20 w-full flex flex-col items-center gap-7"> 
        <MemberCard role="Designer" name="Raouf benbellat"/>
        <MemberCard role="Marketing" name="Raouf benbellat"/>
      </div>
    </div>
  );
};
